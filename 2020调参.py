...
# colors
parser.add_argument("--lower_green", type=int, nargs=3, default=[70, 50, 50], help="lower green threshold")
parser.add_argument("--upper_green", type=int, nargs=3, default=[130, 255, 255], help="upper green threshold")
...
parser.add_argument("--lower_red2", type=int, nargs=3, default=[330, 50, 50], help="lower red threshold 2")
parser.add_argument("--upper_red2", type=int, nargs=3, default=[360, 255, 255], help="upper red threshold 2")
